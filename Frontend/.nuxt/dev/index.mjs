...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://C:/Users/balis/dashboard/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/balis/dashboard/node_modules/@vue/shared/dist/shared.cjs.js';
import { sub } from 'file://C:/Users/balis/dashboard/node_modules/date-fns/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/balis/dashboard/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/balis/dashboard/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/balis/dashboard/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/balis/dashboard/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/balis/dashboard/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/balis/dashboard/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/balis/dashboard/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/balis/dashboard/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/balis/dashboard/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/balis/dashboard/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/balis/dashboard/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/balis/dashboard/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/balis/dashboard/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/balis/dashboard/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/balis/dashboard/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/balis/dashboard/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/balis/dashboard/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/balis/dashboard/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/balis/dashboard/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/balis/dashboard/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/balis/dashboard/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/balis/dashboard/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/balis/dashboard/node_modules/errx/dist/index.js';
import { basename } from 'file://C:/Users/balis/dashboard/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://C:/Users/balis/dashboard/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file://C:/Users/balis/dashboard/.nuxt/nuxt-icon-server-bundle.mjs';
import { walkResolver } from 'file://C:/Users/balis/dashboard/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/balis/dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/balis/dashboard","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/balis/dashboard/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/balis/dashboard/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/balis/dashboard/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/balis/dashboard/.data/kv"}));
...
const _lb3IF58AOBDQOC9tQxLPaZ_NLyiFBbG_4Q1Q7Eyhog = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "C:/Users/balis/dashboard";
...
const _w_f8cEEgxNxxpsx7ppobnfPb46qtwFHInxIBb08H56c = (nitroApp) => {
...
const _zn4v8CLtLG3UpeGhayNZQwz2MKsLd4Zmr7L4m4i6PVg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _lb3IF58AOBDQOC9tQxLPaZ_NLyiFBbG_4Q1Q7Eyhog,
_w_f8cEEgxNxxpsx7ppobnfPb46qtwFHInxIBb08H56c,
_zn4v8CLtLG3UpeGhayNZQwz2MKsLd4Zmr7L4m4i6PVg
];
...
const _14hRWD = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file://C:/Users/balis/dashboard/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/balis/dashboard/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_JD1Omh = () => Promise.resolve().then(function () { return customers$2; });
const _lazy_2jI5xS = () => Promise.resolve().then(function () { return mails$2; });
const _lazy_RMImCW = () => Promise.resolve().then(function () { return members$2; });
const _lazy_RFfDat = () => Promise.resolve().then(function () { return notifications$2; });
const _lazy_QxSlMU = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/customers', handler: _lazy_JD1Omh, lazy: true, middleware: false, method: undefined },
  { route: '/api/mails', handler: _lazy_2jI5xS, lazy: true, middleware: false, method: undefined },
  { route: '/api/members', handler: _lazy_RMImCW, lazy: true, middleware: false, method: undefined },
  { route: '/api/notifications', handler: _lazy_RFfDat, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_QxSlMU, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _14hRWD, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_QxSlMU, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QxSlMU, lazy: true, middleware: false, method: undefined }
];
...
const customers$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: customers$1
});
...
const mails$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: mails$1
});
...
const members$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: members$1
});
...
const notifications$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
